...
<body>
    ...
    <header>
        ...
        <div class = "nav-our-service">
            <div class = "box-nav" align = "center"> 
            <ul class = "button-nav">
                <li class = "hightlight"><a href="our-service-orders-online.php">ONLINE ORDERS</a></li>
                <br>
                <li class = "hightlight"><a href="our-service-booking-table.php">BOOKING A TABLE</a></li>
            </ul>
            </div>
        </div>
</header>
